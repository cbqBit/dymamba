...
def main():
    ...
    # Dataset parameters
    parser.add_argument('-g', '--gt_path', default='/data/cellseg/masks', type=str, help='path to ground truth')
    parser.add_argument('-s', '--seg_path', type=str, default='/data/outpus/dymamba/cellseg', help='path to segmentation results; file names are the same as ground truth', required=False)
    parser.add_argument('--gt_suffix', default='.png', type=str, help='suffix of ground truth names')
    parser.add_argument('--seg_suffix', default='.tif', type=str, help='suffix of segmentation names')
    parser.add_argument('-thre', '--thresholds', nargs='+', default=[0.5], type=float, help='threshold to count correct cells')
    parser.add_argument('-o', '--output_path', default='/data/outpus/', type=str, help='path where to save metrics')
    parser.add_argument('-n', '--save_name', default='unetr', type=str, help='name of the csv file')
